    ...
    <section class="section">
        <form action="{{ $action }}" method="POST">
                    ...
                    <select name="cidade_id" id="cidade_id">
                        ...
                        @foreach ($cidades as $cidade)
                            <option value="{{ $cidade->id }}"
                                {{ old('cidade_id', $imovel->cidade->id ?? '') == $cidade->id ? 'selected' : '' }}>{{ $cidade->nome }}</option>
                        @endforeach
                    </select>
            ...
            <di class="row">
                <div class="input-field col s12">
                    <select name="tipo_id" id="tipo_id">
                        <option disabled selected>Selecione um tipo de imóvel</option>

                        @foreach ($tipos as $tipo)
                            <option
                            value="{{ $tipo->id }}"{{ old('tipo_id', $imovel->tipo->id ?? '') == $tipo->id ? 'selected' : '' }}>{{$tipo->nome }}</option>
                        @endforeach
                    </select>
            ...
            <div class="row">
                ...
                <div class="input-field col s4">
                    <input type="number" name="garagens" id="garagem"
            ...
            <div class="row">
                <div class="inut-field col s12">
                    <label for="proximidades">Pontes de interesse nas proximidades</label>
                    <select name="proximidades[]" id="proximidades" multiple>
                        <option disabled>Selecione os pontos de interesse nas proximidades</option>
